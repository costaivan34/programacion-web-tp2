...
class turno{
    private $fields = ['nombre', 'mail', 'telefono','edad','calzado','altura','fnacimiento','pelo','fecha_turno','hora_turno','diagnostico'];
    ...
    public function setDiag($value){
          move_uploaded_file($value,'./4/diag');
        $this->$fields[diagnostico] = $value;
    }
